...
const GlitchText: FC<GlitchTextProps> = ({
  ...
  const baseClasses = 'text-white font-black relative mx-auto select-none cursor-pointer text-[clamp(4rem,15vw,14rem)] sm:text-[clamp(5rem,16vw,6rem)] md:text-[clamp(6rem,17vw,10rem)] lg:text-[clamp(7rem,18vw,14rem)]';
